...
**下一步：见根目录 `roadmap.md`。** Day 86 起先做 UI/UX + Profile + Lobby 架构（离线 mock），不立刻做主动技能。领域规格：`docs/ui_lobby_architecture.md`。页面布局已锁：`docs/ui_screen_spec.md`。主动技能仍是战斗内容，排在大厅离线 mock 能跑之后。
