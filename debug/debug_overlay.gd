...
func bind_pistol(pistol: Pistol) -> void:
	_pistol = pistol
...
func _read_fire_cooldown() -> float:
	if _pistol == null:
		return 0.0
	return _pistol.get_cooldown_remaining_sec()
...
func _read_refused() -> int:
	if _pistol == null:
		return 0
	return _pistol.get_refused_count()
